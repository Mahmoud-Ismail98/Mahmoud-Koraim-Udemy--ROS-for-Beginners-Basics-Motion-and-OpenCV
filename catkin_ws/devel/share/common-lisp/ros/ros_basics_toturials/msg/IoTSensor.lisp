...
(cl:in-package ros_basics_toturials-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <IoTSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IoTSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_basics_toturials-msg:<IoTSensor> is deprecated: use ros_basics_toturials-msg:IoTSensor instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_toturials-msg:id-val is deprecated.  Use ros_basics_toturials-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_toturials-msg:name-val is deprecated.  Use ros_basics_toturials-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_toturials-msg:temperature-val is deprecated.  Use ros_basics_toturials-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'humidity-val :lambda-list '(m))
(cl:defmethod humidity-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_toturials-msg:humidity-val is deprecated.  Use ros_basics_toturials-msg:humidity instead.")
  (humidity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IoTSensor>)))
  ...
  "ros_basics_toturials/IoTSensor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IoTSensor)))
  "Returns string type for a message object of type 'IoTSensor"
  "ros_basics_toturials/IoTSensor")
