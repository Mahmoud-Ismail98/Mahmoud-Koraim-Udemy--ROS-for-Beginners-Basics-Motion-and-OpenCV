...
(cl:in-package ros_basics_toturials-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_basics_toturials-srv:<AddTwoInts-request> is deprecated: use ros_basics_toturials-srv:AddTwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_toturials-srv:a-val is deprecated.  Use ros_basics_toturials-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_toturials-srv:b-val is deprecated.  Use ros_basics_toturials-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddTwoInts-request>)))
  ...
  "ros_basics_toturials/AddTwoIntsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInts-request)))
  "Returns string type for a service object of type 'AddTwoInts-request"
  "ros_basics_toturials/AddTwoIntsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_basics_toturials-srv:<AddTwoInts-response> is deprecated: use ros_basics_toturials-srv:AddTwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddTwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_toturials-srv:sum-val is deprecated.  Use ros_basics_toturials-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddTwoInts-response>)))
  ...
  "ros_basics_toturials/AddTwoIntsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInts-response)))
  "Returns string type for a service object of type 'AddTwoInts-response"
  "ros_basics_toturials/AddTwoIntsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInts)))
  ...
  "ros_basics_toturials/AddTwoInts")