...
// (in-package ros_basics_toturials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'ros_basics_toturials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_basics_toturials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'ros_basics_toturials/AddTwoInts'; }
};
